...
import { Shield, Lock, Eye, FileText, ChevronRight, Circle } from "lucide-react";
...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="min-h-screen pt-32 pb-40 px-6 lg:px-24 relative overflow-hidden bg-background text-foreground selection:bg-accent/30 font-sans">
      <EditorialBackground text="Nexus" />
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="mb-40 space-y-8">
          ...
          >
            Privacy <span className="text-accent underline decoration-accent/20 underline-offset-[1rem]">Policy</span>
          </motion.h1>
          ...
          <div className="space-y-40">
            {sections.map((section, idx) => (
              ...
              >
                ...
                <div className={`w-full md:w-[45%] ${idx % 2 === 0 ? "md:text-right" : "md:text-left"} pl-16 md:pl-0`}>
                    ...
                    <div className={`flex flex-wrap gap-x-6 gap-y-3 ${idx % 2 === 0 ? "md:justify-end" : "md:justify-start"}`}>
                      {section.details.map((detail, dIdx) => (
                        <div key={dIdx} className="flex items-center gap-2 group cursor-default">
                          <Circle size={4} className="text-accent group-hover:scale-150 transition-all duration-300" fill="currentColor" />

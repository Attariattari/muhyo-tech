            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h4 className="text-3xl md:text-4xl font-bold mb-6 tracking-tight leading-tight italic">
                  Solving the complex, <br />
                  <span className="text-accent underline decoration-accent/30 underline-offset-8">
                    engineering the intuitive.
                  </span>
                </h4>
              ...
              >
                ...
                <Card className="p-10 border border-border/50 bg-card/80 backdrop-blur-xl rounded-[3rem] shadow-2xl relative overflow-hidden">
                  ...
                  <p className="text-muted-foreground text-base mb-10 leading-relaxed font-medium">
                    Transform your digital landscape with high-performance
                    engineering tailored to your vision.
                  </p>

                  <div className="space-y-4">
                    <Link href="/contact" className="block">
                      <Button className="w-full h-16 text-sm font-black uppercase tracking-[0.2em] bg-accent hover:bg-accent/90 text-white rounded-2xl shadow-xl shadow-accent/20 group/btn overflow-hidden relative">
                    ...
                    <Button
                      variant="outline"
                      className="w-full h-16 text-sm font-black uppercase tracking-[0.2em] text-foreground border-border/50 hover:bg-foreground/5 rounded-2xl transition-all"
                    >
                      Schedule Call
                    </Button>
                  </div>
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-2xl bg-accent/5 border border-accent/10">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-muted-foreground leading-normal font-medium">
                          Secure IP protection and standard legal compliance.
                        </p>
                      </div>
                    </div>
                  </div>

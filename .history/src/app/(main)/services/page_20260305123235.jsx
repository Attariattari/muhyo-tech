...
export default function ServicesPage() {
  ...
  return (
    <div className=" min-h-screen pt-20">
      {/* Hero Section */}
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center pt-24 pb-20 overflow-hidden bg-gradient-to-b from-background to-secondary/5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-black text-foreground mb-8 leading-tight tracking-tighter">
                ...
                Into{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent via-blue-500 to-accent bg-300% animate-gradient">
                  Digital Excellence
                </span>
              </h1>

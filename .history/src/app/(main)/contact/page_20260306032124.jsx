  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 px-8 overflow-hidden">
        ...
        >
          ...
          >
            ...
            <h1 className="text-[clamp(3.5rem,10vw,8.5rem)] font-black tracking-tighter text-foreground leading-[0.85] md:leading-[0.8]">
              Architecting <br />
              <span className="bg-gradient-to-br from-accent via-blue-400 to-indigo-500 bg-clip-text text-transparent">
                Strategic
              </span>{" "}
              <br />
              Excellence.
            ...
            <p className="text-xl md:text-3xl text-muted-foreground font-medium max-w-4xl mx-auto leading-relaxed md:px-12">
              Engineering <span className="text-foreground">elite-grade</span>{" "}
              digital systems for global leaders. Sub-second performance meets{" "}
              <span className="italic">uncompromising</span> scale.
            </p>
          ...
          >
            {[
              ...
              <div key={i} className="flex items-center gap-4 group/stat">
                <div
                  className={`w-2 h-2 ${stat.dot} rounded-full group-hover/stat:scale-[2] transition-transform`}
                />
        ...
        >
          <div className="text-[9px] font-black text-accent uppercase tracking-[0.8em] rotate-90 mb-8 origin-center translate-y-4">
            SCROLL
          </div>
          ...
          <div className="lg:col-span-5 space-y-24 lg:sticky lg:top-32">
            <div className="space-y-10">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-lg font-medium">
                Designing resilient architectures that serve as the
                technological backbone for high-stakes digital environments.
              </p>
            </div>
              ...
              {[
                {
                  icon: <ShieldCheck />,
                  title: "Security",
                  text: "Zero-trust protocols for mission integrity.",
                },
                {
                  icon: <Zap />,
                  title: "Performance",
                  text: "Sub-second global runtime execution.",
                },
                {
                  icon: <Layers />,
                  title: "Scale",
                  text: "Elastic architecture for millions of users.",
                },
                {
                  icon: <Cpu />,
                  title: "Intelligence",
                  text: "Adaptive logic & data-driven insights.",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="space-y-4 p-8 rounded-[2rem] bg-card/5 border border-white/5 hover:border-accent/40 transition-all group shadow-inner"
                >
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end gap-12 mb-32">
            ...
            <div className="text-right pb-4">
              ...
              <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[.4em] opacity-40">
                UTC+05:00 Terminal
              </p>
            </div>
          </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-white/40 uppercase font-black tracking-widest mt-1">
                        Unified Connectivity for Strategic Partners
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="w-1 h-8 bg-white/10 rounded-full overflow-hidden relative"
                      >
                        <motion.div

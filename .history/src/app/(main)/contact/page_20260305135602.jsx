            ...
            <Tilt {...tiltOptions}>
              <div className="relative z-10 p-3 glass rounded-[3rem] overflow-hidden group-hover:border-accent/40 transition-all duration-700 shadow-2xl">
                <div className="relative w-full aspect-square md:aspect-[4/3] rounded-[2.5rem] overflow-hidden">
                  <Image
                    src="/images/contact-professional.png"
                    alt="Professional Technical Collaboration"
                    fill
      ...
      <section className="relative w-full pt-20">
        <div className="max-w-7xl mx-auto px-4 mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl font-medium leading-relaxed">
            Based in Chung, Lahore, I operate at the intersection of local
            expertise and global technical standards. Whether you're nearby or
            across the ocean, I provide seamless collaboration and
            high-performance digital solutions tailored to your unique market
            needs.
          </p>
        </div>

        <div className="w-full h-[500px] relative mt-8 grayscale hover:grayscale-0 transition-all duration-700">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13622.793796568288!2d74.18641974716766!3d31.394861877903!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3918ff8689975f2b%3A0xe5a3c2677864dd1e!2sChung%2C%20Lahore%2C%20Punjab%2C%20Pakistan!5e0!3m2!1sen!2s!4v1709673600000!5m2!1sen!2s"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen=""

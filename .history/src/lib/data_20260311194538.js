export const portfolioData = {
    ...
    projects: [{
            id: 1,
            title: "Quantum E-Commerce Ecosystem",
            description: "A high-performance retail engine featuring real-time inventory sync, complex discount logic, and a bespoke design system.",
            techStack: [
                "Next.js",
                "Tailwind CSS",
                "Stripe",
            ...
            purpose: "Retail & FinTech",
            problemSolved: "The client faced 4s+ load times and high cart abandonment. We re-engineered the entire checkout flow and implemented heavy SSR caching.",
            impact: "45% reduction in bounce rate and 30% increase in mobile conversion within the first quarter of launch.",
            techStackDetail: [
                { name: "Next.js", level: "Core Engine" },
                { name: "Stripe", level: "Payment Infrastructure" },
                { name: "MongoDB", level: "Data Persistence" },
            ...
            liveLink: "https://quantum-shop.demo",
            githubLink: "https://github.com/muhyotech/quantum-shop",
            thumbnail: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1200",
        },
        {
            id: 2,
            title: "Skyline Real Estate Portal",
            description: "An immersive property discovery platform with interactive map search, virtual tour integration, and mortgage calculators.",
            techStack: [
                "React",
                "Node.js",
                "Google Maps API",
            ...
            category: "Web Development",
            purpose: "PropTech",
            problemSolved: "Traditional listings lacked real-time interaction. We developed a live bidding and chat system to connect buyers and sellers instantly.",
            impact: "Handled 10k+ concurrent users during peak launch hours with zero latency in map rendering.",
            techStackDetail: [
                { name: "React", level: "Frontend Core" },
                { name: "Node.js", level: "Backend Logic" },
                { name: "PostgreSQL", level: "Relational Data" },
                { name: "Socket.io", level: "Real-time Sync" },
            ],
            gallery: [
            ...
            liveLink: "https://skyline-portal.demo",
            githubLink: "https://github.com/muhyotech/skyline-portal",
            thumbnail: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?q=80&w=1200",
        },
        {
            id: 3,
            title: "Zenith UI Kit & Design System",
            description: "A comprehensive design language and component library built for rapid enterprise application prototyping.",
            techStack: ["Figma", "Framer", "React", "Storybook", "Tailwind"],
            category: "UI/UX Design",
            purpose: "Design Systems",
            problemSolved: "Inconsistent UI across 5 different internal tools. We created a single source of truth for the company's brand and interaction patterns.",
            impact: "Accelerated development speed by 60% for future internal projects.",
            techStackDetail: [
                { name: "Figma", level: "Design Source" },
                { name: "Storybook", level: "Documentation" },
                { name: "Tailwind", level: "CSS Tokens" },
                { name: "Framer", level: "High-Fidelity Interaction" },
            ],
            gallery: [
                ...
                "https://images.unsplash.com/photo-1618788323020-519d980f996e?q=80&w=2000&auto=format&fit=crop",
            ],
            liveLink: "https://zenith-ui.demo",
            githubLink: "https://github.com/muhyotech/zenith-ui",
            thumbnail: "https://images.unsplash.com/photo-1558655146-d09347e92766?q=80&w=1200",
        },
        {
            id: 4,
            title: "Nexus Mobile Banking App",
            description: "A secure, biometric-enabled mobile finance application with real-time transaction tracking and AI spending insights.",
            techStack: [
                "React Native",
                "Firebase",
                "Node.js",
            ...
            category: "Mobile App",
            purpose: "FinTech",
            problemSolved: "Users found banking apps too complex. We simplified the interface using a 'One-Action' design philosophy for common tasks.",
            impact: "App Store rating increased from 3.2 to 4.8 stars after the redesign and technical overhaul.",
            techStackDetail: [
                { name: "React Native", level: "Cross-Platform" },
                { name: "Firebase", level: "Auth & Real-time" },
                { name: "Reanimated", level: "Native Animations" },
                { name: "Node.js", level: "Secure Middleware" },
            ],
            gallery: [
            ...
            liveLink: "https://nexus-banking.demo",
            githubLink: "https://github.com/muhyotech/nexus-banking",

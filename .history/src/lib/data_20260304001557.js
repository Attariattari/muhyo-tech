export const portfolioData = {
  profile: {
    ...
    bio: "Passionate about building scalable web applications and premium digital experiences.",
    longDescription:
      "With over 8 years of experience in the software industry, I specialize in crafting high-performance web applications using modern technologies. My mission is to bridge the gap between complex backend logic and intuitive, beautiful frontend experiences. I value clean code, accessibility, and user-centric design in every project I undertake.",
    mission:

export const portfolioData = {
  profile: {
    ...
    bio: "Expert Full-Stack Engineer dedicated to architecting high-performance digital solutions and premium user experiences.",
    longDescription:
      "With over 3+ years of professional experience in the software engineering landscape, I specialize in developing scalable, high-performance web applications. My expertise lies in bridging the gap between complex technical requirements and seamless, intuitive user interactions. I am committed to delivering excellence through clean architecture, robust logic, and cutting-edge design standards.",
    mission:
      "To empower businesses through cutting-edge technology and exceptional design.",
    values: [
      "Innovation",
      "Excellence",
      "Integrity",

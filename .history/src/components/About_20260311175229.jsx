...
export default function About({ data, skills }) {
  ...
  return (
    <div className="flex flex-col gap-24 py-12">
      {/* Hero Section */}
      <SectionWrapper id="about-hero" title="The Architect Behind the Screen" subtitle="Who I Am">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-[90%] grid grid-cols-3 gap-3">
              {highlights.map((h, i) => (
                ...
                >
                  ...
                  <div className="text-xs lg:text-sm font-black whitespace-nowrap">{h.value}</div>
                  <div className="text-[10px] text-muted-foreground uppercase tracking-tight">{h.label}</div>
                </motion.div>
              ))}
            </div>
          </motion.div>
          ...
          >
            ...
            >
              Hi, I&apos;m <span className="text-accent">{data.name.split(' ')[0]}</span>. <br />
              I&apos;m a{" "}
      ...
      <div className="relative py-24 overflow-hidden">
        ...
        <SectionWrapper id="philosophy" title="Digital Craftsmanship" subtitle="My Approach">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {philosophy.map((item, i) => (
              ...
              >
                ...
                <h4 className="text-xl font-black mb-4 group-hover:text-accent transition-colors">{item.title}</h4>
      ...
      {skills && (
        <SectionWrapper id="skills-detailed" title="Technical Arsenal" subtitle="Tools of Trade">
              ...
              {skills.map((skill, i) => (
                ...
                >
                    <div className="flex justify-between items-center">
                        ...
                        <span className="text-[10px] bg-accent/10 px-2 py-0.5 rounded-full text-accent font-black">{skill.category}</span>
                    </div>
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="text-2xl md:text-4xl font-black italic mb-8 max-w-3xl mx-auto leading-tight">
              &quot;The only way to do great work is to love what you do, and to build it so well that it lasts beyond you.&quot;
            </h2>
            <div className="flex flex-col items-center gap-2">
              <div className="w-12 h-1 bg-accent rounded-full mb-2" />
              <p className="text-accent font-black uppercase tracking-widest text-sm">Let&apos;s build something together</p>
            </div>
          </div>
        </motion.div>
      </SectionWrapper>

      ...
      >
        ...
        >
          <div className="relative group/logo">
            ...
            {/* The Insignia Box */}
            <div className="relative w-12 h-12 rounded-2xl bg-gradient-to-br from-background/80 to-muted/30 border border-white/10 flex items-center justify-center text-foreground font-black text-2xl shadow-2xl transition-all duration-500 group-hover/logo:scale-110 group-hover/logo:rotate-6 backdrop-blur-xl group-hover/logo:border-accent/30">
              M
              <span className="text-accent drop-shadow-[0_0_8px_var(--accent)]">
                .
              </span>
            </div>
          </div>

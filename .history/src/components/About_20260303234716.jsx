      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        >
          <Tilt options={tiltOptions}>
            {/* Professional Portrait - Blended with CSS */}
            <div className="relative w-full aspect-[4/5] overflow-hidden rounded-[2rem] [mask-image:radial-gradient(ellipse_at_center,black_60%,transparent_100%)]">
              <Image
                src="/about-profile-new.jpg"
                alt="Muhyo Tech Profile"
                fill
                className="object-cover transition-transform duration-700 group-hover:scale-105 contrast-[1.1] brightness-[0.9] saturate-[1.1]"
                priority
              />
              {/* Professional Theme Grading */}
              <div className="absolute inset-0 bg-accent/10 mix-blend-color pointer-events-none" />
              <div className="absolute inset-0 bg-gradient-to-t from-background via-transparent to-transparent opacity-80" />
              <div className="absolute inset-0 ring-1 ring-inset ring-accent/20 rounded-[2rem]" />
            </div>
          </Tilt>

          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
              <motion.a
                ...
                whileHover={{ y: -5 }}
                className="px-8 py-4 bg-foreground text-background font-black uppercase text-[10px] tracking-[0.3em] rounded-xl flex items-center gap-2"
              >
              ...
              <motion.a
                ...
                whileHover={{ y: -5 }}
                className="px-8 py-4 bg-emerald-500 text-white font-black uppercase text-[10px] tracking-[0.3em] rounded-xl flex items-center gap-2"
              >
              ...
              <motion.a
                ...
                whileHover={{ y: -5 }}
                className="px-8 py-4 glass border-border/80 text-foreground font-black uppercase text-[10px] tracking-[0.3em] rounded-xl flex items-center gap-2"
              >
              ...
              <div className="flex items-center justify-center lg:justify-end gap-4">
                {socialLinks.map((social, idx) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-12 h-12 rounded-xl glass flex items-center justify-center text-muted-foreground hover:text-accent hover:border-accent/40 shadow-xl transition-all"

  ...
  return (
    <SectionWrapper id="blog">
      ...
      <div className="relative pt-24 pb-20 px-6 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-accent/5 to-transparent -z-10" />

        <div className="max-w-7xl mx-auto">
          {/* Header Metadata Row */}
          <div className="flex flex-wrap items-center justify-between gap-6 pb-8 border-b border-border/10 mb-16">
            <motion.div
              initial={{ opacity: 0, x: -20 }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-7 space-y-10">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <span className="px-3 py-1 bg-accent/10 border border-accent/20 rounded text-[9px] font-black text-accent uppercase">
                    Documentation
                  </span>
                  <span className="text-muted-foreground/30 text-[9px] font-mono">
                    /journal/2024
                  </span>
                </div>
                <h1 className="text-6xl md:text-8xl font-bold tracking-tight text-white leading-[0.9]">
                  ...
                  <span className="relative">
                    ...
                    <motion.div
                      ...
                      className="absolute -bottom-2 left-0 h-1 bg-accent/40"
                    />
                  </span>
                </h1>
              </motion.div>
              ...
              >
                Decoding the complex patterns behind high-performance digital
                systems and professional engineering culture.
              </motion.p>
            </div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="lg:col-span-5 space-y-8 p-1 bg-card/20 border border-border/10 rounded-3xl backdrop-blur-sm shadow-2xl"
            >
              {/* Command Palette Search */}
              <div className="relative group p-4 border-b border-border/10">
                ...
                <input
                  type="text"
                  placeholder="EXEC SEARCH_IN_ARCHIVE('QUERY')..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full bg-background/40 border border-border/20 rounded-xl py-4 px-6 text-xs font-mono text-accent placeholder:text-muted-foreground/20 focus:outline-none focus:border-accent/40 transition-all font-bold"
                />
              </div>

              {/* Category Protocol */}
              <div className="p-6 pt-0 space-y-4">
                <span className="text-[9px] font-black text-foreground/40 uppercase tracking-widest px-2">
                  Category protocol
                </span>
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${
                        activeCategory === category
                          ? "bg-accent text-accent-foreground shadow-[0_0_20px_rgba(var(--accent-rgb),0.3)]"

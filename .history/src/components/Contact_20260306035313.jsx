          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="group relative px-10 py-5 bg-card/40 border border-white/20 rounded-2xl flex items-center gap-4 transition-all duration-500 overflow-hidden"
              >
                ...
                <div className="relative z-10 p-2 rounded-xl bg-white/10 group-hover:bg-black/5 transition-colors duration-500">
                  <Mail className="w-5 h-5 text-white group-hover:text-[#0a0f1c] transition-colors duration-500" />
                </div>
                <span className="relative z-10 text-white group-hover:text-[#0a0f1c] font-black uppercase text-[13px] tracking-[0.2em] transition-colors duration-500">
                  Email Us
                </span>
                <div className="absolute top-0 right-0 p-1 opacity-0 group-hover:opacity-10 transition-all duration-500">
              ...
              <motion.a
                ...
                whileHover={{ y: -5, scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="group relative px-10 py-5 bg-card/40 border border-[#25D366]/30 rounded-2xl flex items-center gap-4 transition-all duration-500 overflow-hidden"
              >
                <div className="absolute inset-0 bg-[#25D366] translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-[0.16,1,0.3,1]" />
                <div className="relative z-10 p-2 rounded-xl bg-[#25D366]/15 group-hover:bg-black/5 transition-colors duration-500">
                  <MessageCircle className="w-5 h-5 text-[#25D366] group-hover:text-[#0a0f1c] transition-colors duration-500" />
                </div>
                <span className="relative z-10 text-white group-hover:text-[#0a0f1c] font-black uppercase text-[13px] tracking-[0.2em] transition-colors duration-500">
                  WhatsApp
                </span>
                <div className="absolute -bottom-2 -right-2 p-1 opacity-0 group-hover:opacity-10 transition-all duration-500">
              ...
              <motion.a
                ...
                whileHover={{ y: -5, scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="group relative px-10 py-5 bg-card/40 border border-accent/30 rounded-2xl flex items-center gap-4 transition-all duration-500 overflow-hidden"
              >
                ...
                <div className="relative z-10 p-2 rounded-xl bg-accent/15 group-hover:bg-black/5 transition-colors duration-500">
                  <Phone className="w-5 h-5 text-accent group-hover:text-[#0a0f1c] transition-colors duration-500" />
                </div>
                <span className="relative z-10 text-white group-hover:text-[#0a0f1c] font-black uppercase text-[13px] tracking-[0.2em] transition-colors duration-500">
                  Call Now
                </span>
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-black/5 rounded-full scale-0 group-hover:scale-100 transition-transform duration-700 pointer-events-none" />
              </motion.a>
            </div>
          </div>

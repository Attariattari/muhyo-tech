    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="absolute -right-3 top-1/2 -translate-y-1/2 w-6 h-20 glass border border-border rounded-full flex items-center justify-center text-muted-foreground hover:text-accent transition-all hover:h-24 group/toggle shadow-xl"
        >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="lg:hidden fixed inset-0 bg-background z-[70] p-10 flex flex-col"
          >

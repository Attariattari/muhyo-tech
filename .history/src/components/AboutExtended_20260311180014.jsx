...
const StatCounter = ({ value, label, index }) => {
  ...
  const isInView = true; // Simplified for this component
  ...
  return (
    <motion.div
      ...
      className="relative flex flex-col items-center p-8 glass rounded-3xl border border-white/5 hover:border-accent/30 transition-all duration-500 group"
    >

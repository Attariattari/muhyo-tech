  ...
  >
    <Card className="p-4 border border-border/10 overflow-hidden group">
      <div className="relative aspect-video rounded-xl bg-card/60 overflow-hidden border border-border/10 mb-6 group-hover:shadow-2xl transition-all duration-300">
        <div className="absolute inset-0 bg-accent/20 opacity-0 group-hover:opacity-100 transition-opacity z-10 flex items-center justify-center gap-4">
          <a
            ...
            target="_blank"
            className="p-3 rounded-full bg-accent text-accent-foreground hover:scale-110 transition-transform cursor-pointer"
          >
          ...
          <a
            ...
            target="_blank"
            className="p-3 rounded-full bg-background text-foreground hover:scale-110 transition-transform cursor-pointer border border-border"
          >
      ...
      <div className="px-4 pb-4">
        <h3 className="text-xl font-black mb-3 text-foreground group-hover:text-accent transition-colors italic uppercase tracking-tighter">
          {project.title}
        </h3>
        ...
        <Link href={`/projects`} className="w-full">
          <button className="w-full py-4 rounded-xl border border-accent/20 bg-accent text-accent-foreground shadow-lg shadow-accent/20 hover:shadow-accent/40 text-[10px] font-black uppercase tracking-[0.3em] transition-all flex items-center justify-center gap-2 group cursor-pointer">
            View Blueprint <ExternalLink className="w-4 h-4" />
          </button>
        </Link>
      </div>
    </Card>
  ...
  return (
    ...
    >
      ...
      <div className="mt-20 text-center">
        <Link href="/projects">
          <button className="px-10 py-5 rounded-full border border-border text-foreground hover:bg-card transition-all font-black uppercase text-xs tracking-[0.2em] cursor-pointer">

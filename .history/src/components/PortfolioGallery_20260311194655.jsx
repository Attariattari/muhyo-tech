      ...
      <SectionWrapper id="portfolio">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-32">
          {[
            ...
            { label: "Industry Awards", value: "12", icon: Palette },
            { label: "System Uptime", value: "99.9%", icon: Smartphone },
          ].map((stat, i) => (
            <motion.div
              key={i}
              ...
              className="glass p-8 rounded-[2.5rem] border border-border/50 text-center group hover:border-accent/30 transition-all hover:-translate-y-2"
            >
              <div className="w-12 h-12 rounded-2xl bg-accent/10 text-accent flex items-center justify-center mx-auto mb-6 group-hover:bg-accent group-hover:text-accent-foreground transition-all duration-500">
                <stat.icon size={24} />
              </div>
              <div className="text-4xl font-black text-foreground mb-1 italic tracking-tighter">
                {stat.value}
              </div>
              <div className="text-[10px] font-black uppercase tracking-[0.2em] text-accent opacity-60 group-hover:opacity-100 transition-opacity">
                {stat.label}
              </div>
            </motion.div>
          ))}

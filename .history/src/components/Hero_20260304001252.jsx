      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col items-start text-left">
            ...
            >
              Full-Stack Engineer with 3+ years of experience in architecting
              high-performance, visually stunning digital solutions. Specialist
              in Next.js and modern engineering standards.
            </motion.p>

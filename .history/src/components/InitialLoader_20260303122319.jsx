    ...
    <AnimatePresence>
      {loading && (
        <motion.div
          ...
          className="fixed inset-0 z-[10000] flex items-center justify-center bg-background transition-colors duration-500"
        >
          {/* Background Elements */}
          <div
          ...
          <div className="relative flex flex-col items-center">
            ...
            >
              <div className="w-32 h-32 flex items-center justify-center glass rounded-[2.5rem] border border-accent/20 shadow-[0_0_80px_rgba(var(--accent-rgb),0.15)]">
                <span className="text-6xl font-black text-foreground tracking-tighter animate-shimmer">

        ...
        >
            ...
            <div className="flex flex-wrap gap-4">
              {[
                ...
                <button
                  key={cat}
                  type="button"
                  className="px-8 py-4 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] border border-white/5 bg-white/[0.02] hover:bg-accent/10 hover:border-accent/40 transition-all duration-500 shadow-inner group/cat"
                >
                  <span className="group-hover/cat:text-foreground transition-colors">
                    {cat}
                  </span>
                </button>
              ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            ...
            <div className="space-y-8 flex flex-col justify-center">
              <div className="p-6 rounded-3xl bg-accent/5 border border-accent/10 space-y-4 shadow-2xl">
                ...
                <p className="text-[11px] text-muted-foreground font-medium leading-relaxed">
                  Every project brief is reviewed by a Senior Solutions
                  Architect.
                </p>
              </div>
              ...
              <div className="flex items-center gap-4 px-2">
                ...
                <span className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest leading-tight">
                  ...
                  <span className="text-foreground">Syncing Now</span>
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="pt-8 relative overflow-hidden">
            <motion.button
              ...
              className="group w-full py-10 rounded-[2.5rem] bg-foreground text-background font-black uppercase text-xs tracking-[0.6em] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.4)] hover:bg-accent hover:text-white transition-all duration-700 flex items-center justify-center gap-6 disabled:opacity-50 overflow-hidden relative"
            >
              <AnimatePresence mode="wait">
                {isSending ? (
                  ...
                  <motion.div key="default" className="flex items-center gap-4">
                    ...
                    <Send className="w-5 h-5 group-hover:translate-x-2 group-hover:-translate-y-2 transition-transform duration-700" />
                  </motion.div>
                )}
              </AnimatePresence>
        ...
        <div className="pt-20 grid grid-cols-1 sm:grid-cols-2 gap-8 border-t border-white/5 relative z-10">
          {contactInfo.map((info, idx) => (
            <motion.a
              ...
              className="flex items-center justify-between p-10 rounded-[3rem] bg-white/[0.02] border border-white/5 group transition-all duration-700 hover:border-accent/40"
            >
              <div className="flex items-center gap-6">
                <div
                  className={`p-6 rounded-2xl bg-white/5 ${info.color} group-hover:bg-accent group-hover:text-white group-hover:shadow-[0_0_30px_rgba(59,130,246,0.3)] transition-all duration-700`}
                >
                  {info.icon}
                </div>
                <div className="space-y-1">
                  <div className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground opacity-40">
                    {info.label}
                  </div>
                  <div className="text-xl font-black tracking-tight text-foreground transition-colors group-hover:text-accent">
                    {info.value}
                  </div>
                </div>
              </div>
              <ArrowRight className="w-5 h-5 opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:translate-x-0 transition-all duration-700 text-accent" />
            </motion.a>
          ))}
        </div>
      </div>

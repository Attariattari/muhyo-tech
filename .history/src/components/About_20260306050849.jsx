    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-stretch">
        ...
        >
          <div className="relative group perspective-1000">
            ...
            >
              ...
              <span className="text-[8px] font-black uppercase tracking-widest text-black/60 mt-1">
                Yrs Exp
              </span>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            {bentoStats.map((stat, i) => (
              <div
                key={i}
                className="glass-dark p-4 rounded-3xl border border-white/5 flex flex-col items-center gap-2 group/stat hover:border-accent/30 transition-all"
              >
                <stat.icon
        ...
        >
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <p className="text-muted-foreground text-xl md:text-2xl leading-relaxed font-medium max-w-2xl opacity-90">
              {data.longDescription ||
                "Bridging the gap between conceptual complexity and intuitive digital experiences through rigorous engineering."}
            </p>
          </motion.div>
          ...
          <motion.div
            variants={itemVariants}
            className="relative p-8 rounded-[2.5rem] bg-gradient-to-br from-accent/10 to-transparent border border-white/5 overflow-hidden"
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center justify-between">
              <div className="space-y-2 text-center md:text-left">
                ...
                <p className="text-muted-foreground text-xs font-bold leading-relaxed max-w-xs">
                  Deploying enterprise-grade solutions that prioritize scalable
                  architecture, security mesh integrations, and extreme

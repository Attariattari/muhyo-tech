          ...
          {contactInfo.map((info, idx) => (
            ...
            >
              <div className="flex items-center gap-6">
                <div
                  className={`p-5 rounded-2xl bg-white/5 ${info.color} group-hover:bg-accent group-hover:text-white group-hover:shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all duration-500`}
                >
                  {info.icon}
                </div>
                <div className="space-y-1">
                  ...
                  <div className="text-lg font-bold group-hover:text-foreground transition-colors">
                    {info.value}
                  </div>
                </div>
              </div>

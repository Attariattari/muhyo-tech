  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-4">
      ...
      <motion.button
        ...
        className="w-16 h-16 rounded-full bg-emerald-500 flex items-center justify-center text-white shadow-2xl shadow-emerald-500/30 relative group cursor-pointer  border-[#020617]"
      >
        {/* Pulse Animation */}

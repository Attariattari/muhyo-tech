      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        >
          <Tilt options={tiltOptions}>
            {/* Profile Image - Professional Integration */}
            <div className="relative w-full aspect-[4/5] [mask-image:radial-gradient(ellipse_at_center,black_70%,transparent_100%)] overflow-hidden rounded-[2rem]">
              <Image
                ...
                priority
              />
              {/* Deep Professional Gradient Overlays */}
              <div className="absolute inset-0 bg-gradient-to-t from-background via-background/20 to-transparent opacity-80" />
              <div className="absolute inset-0 bg-accent/10 mix-blend-color opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
            </div>
          </Tilt>

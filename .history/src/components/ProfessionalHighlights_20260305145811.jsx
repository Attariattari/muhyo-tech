        ...
        {highlights.map((item, index) => (
          <SwiperSlide key={index}>
            <motion.div
              ...
              className="h-full"
            >
              <div className="h-full p-12 bg-card/20 border border-border/60 rounded-[3rem] group hover:border-accent hover:bg-card/40 transition-all duration-500 backdrop-blur-md relative overflow-hidden">

...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-background border-t border-border/50 py-32 px-3 lg:px-12 overflow-hidden mt-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
          <div className="lg:col-span-5 space-y-8">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed max-w-md italic font-light">
              Crafting mission-critical digital experiences for global technical
              leaders. Engineering precision, obsidian aesthetics, and scalable
              architectures.
            </p>
        ...
        <div className="mt-32 pt-12 border-t border-border/30 flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="flex flex-col gap-2">
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground opacity-50">
              &copy; {new Date().getFullYear()} MUHYO TECH ARCHITECTURES. ALL
              LOGIC RESERVED.
            </p>

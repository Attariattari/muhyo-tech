    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 w-full h-20 bg-background/60 backdrop-blur-xl border-b border-white/5 z-[60] px-8 flex items-center justify-between">
        <Link href="/" className="group flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-accent to-blue-600 flex items-center justify-center text-white font-black text-xl shadow-lg shadow-accent/20">
            M
          </div>
      ...
      >
        ...
        <div className="p-6 mb-8 flex items-center gap-4">
          <div className="relative group/logo">
            <div className="absolute inset-0 bg-accent blur-xl opacity-20 group-hover/logo:opacity-40 transition-opacity" />
            <div className="relative w-12 h-12 rounded-2xl bg-gradient-to-tr from-[#0a0f1c] to-[#1e293b] border border-white/10 flex items-center justify-center text-white font-black text-2xl shadow-xl transition-transform group-hover/logo:scale-105">
          ...
          {!isCollapsed && (
            ...
            >
              ...
              <span className="text-[10px] text-accent font-bold uppercase tracking-[0.3em] mt-1">
                Portfolio v4
              </span>
            </motion.div>
          )}

...
export default function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen flex flex-col justify-center items-center px-4 pt-20 pb-20 overflow-hidden"
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          style={{ y: y1 }}
          className="absolute top-[-10%] left-[-5%] w-[60%] h-[60%]  rounded-full blur-[140px] animate-floating"
        />
        <motion.div
          style={{ y: y2 }}

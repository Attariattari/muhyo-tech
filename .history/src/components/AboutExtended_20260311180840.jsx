  ...
  return (
    <div className="relative overflow-hidden pb-24 -mt-12 lg:-mt-24">
      ...
      <SectionWrapper subtitle="Expertise" title="Core Pillars">
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className="w-14 h-14 rounded-2xl bg-accent/10 flex items-center justify-center mb-6 border border-accent/20 group-hover:scale-110 transition-transform duration-500 group-hover:shadow-[0_0_30px_rgba(var(--accent-rgb),0.3)]">
        ...
        {/* Tech Stack Strip */}
        <div className="mb-24 overflow-hidden relative py-10 bg-accent/5 -mx-6 lg:-mx-16 px-6 lg:px-16 border-y border-accent/10">
          <motion.div
            initial={{ opacity: 0 }}
        ...
        >
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(var(--accent-rgb),0.1)_0%,transparent_50%)]" />
          ...
          <div className="relative z-10 flex flex-col items-center gap-8">
            ...
            <Link href="/contact" className="mt-4">
              <Button className="group/btn relative overflow-hidden px-12 py-6 bg-accent hover:bg-accent/90 text-accent-foreground text-base shadow-[0_20px_40px_rgba(var(--accent-rgb),0.3)] transition-all duration-300 font-black uppercase tracking-[0.2em]">

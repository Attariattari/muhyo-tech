...
export default function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen flex flex-col justify-center px-6 pt-12 lg:pt-28 pb-20 overflow-hidden"
    >
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <motion.div
          ...
          className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mr-auto border-t border-border/10 lg:mt-12 lg:pt-12"
        >

          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
              <motion.a
                ...
                className="px-10 py-5 bg-white text-black font-extrabold uppercase text-[13px] tracking-[0.15em] rounded-2xl flex items-center gap-3 shadow-[0_20px_40px_-12px_rgba(255,255,255,0.2)] transition-all"
              >
              ...
              <motion.a
                ...
                whileHover={{ y: -5, scale: 1.05 }}
                className="px-10 py-5 bg-[#25D366] text-white font-extrabold uppercase text-[13px] tracking-[0.15em] rounded-2xl flex items-center gap-3 shadow-[0_20px_40px_-12px_rgba(37,211,102,0.3)] transition-all"
              >
              ...
              <motion.a
                ...
                whileHover={{ y: -5, scale: 1.05 }}
                className="px-10 py-5 bg-accent text-white font-extrabold uppercase text-[13px] tracking-[0.15em] rounded-2xl flex items-center gap-3 shadow-[0_20px_40px_-12px_rgba(var(--accent),0.3)] transition-all"
              >

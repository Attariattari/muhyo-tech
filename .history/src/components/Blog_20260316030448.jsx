...
const BlogHero = () => (
  <header className="relative pt-32 pb-16 px-6 overflow-hidden">
    ...
    <div className="absolute top-0 left-0 w-full h-[600px] bg-gradient-to-b from-accent/5 to-transparent -z-10" />
    <div className="absolute inset-0 -z-20 opacity-[0.02] [background-image:radial-gradient(#fff_1px,transparent_1px)] [background-size:24px_24px]" />
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <motion.nav
        ...
        className="flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.4em] text-muted-foreground/40 mb-12"
      >
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
        ...
        <motion.p
          ...
          className="text-xl md:text-2xl text-muted-foreground/60 font-medium max-w-md italic leading-tight"
        >
          &quot;Documenting the patterns of modern software design.&quot;
        </motion.p>
      </div>
    </div>
  </header>

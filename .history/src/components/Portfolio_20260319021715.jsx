...
const Portfolio = ({ projects }) => {
  ...
  return (
    <div className="relative overflow-hidden ">
      {/* 1. Hero Section */}
      <section className="relative py-24 lg:py-32 px-6 overflow-hidden min-h-[90vh] flex items-center">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-[0.02] dark:opacity-[0.04] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]">
          ...
          <motion.div
            ...
            className="absolute top-1/4 right-[5%] w-[500px] h-[500px] bg-accent/5 blur-[120px] rounded-full"
          />
          ...
          <motion.div
            ...
            className="absolute -bottom-24 -left-24 w-[400px] h-[400px] bg-accent/3 blur-[100px] rounded-full"
          />
        </div>

        {/* Vertical Label */}
        <div className="hidden xl:block absolute left-8 top-1/2 -translate-y-1/2 -rotate-90 origin-left z-20">
          <span className="text-[10px] font-black text-muted-foreground/20 uppercase tracking-[1em]">
            ENGINEERING ARCHIVE / 2026
          </span>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-accent/10 border border-accent/20 mb-8"
              >
              ...
              <motion.h1
                ...
                className="text-5xl sm:text-6xl md:text-8xl font-black tracking-tighter text-foreground leading-[0.85] uppercase italic mb-10"
              >
                Engineering <br />
              ...
              <motion.p
                ...
                className="text-muted-foreground text-base md:text-xl leading-relaxed mb-12 max-w-xl font-medium italic border-l-2 border-accent/20 pl-8 py-2"
              >
              ...
              {/* Redesigned Trust/Stats Meta */}
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 0.4 }}
                className="flex flex-wrap gap-12 pt-12 border-t border-border/10 mt-12"
              >

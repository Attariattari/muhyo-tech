...
const ArticleCard = ({ blog, index }) => (
  ...
  >
    ...
    <div className="absolute  bg-gradient-to-r from-accent/20 to-blue-600/20 rounded-[1.5rem] opacity-0 group-hover:opacity-100 blur-2xl transition-all duration-700" />

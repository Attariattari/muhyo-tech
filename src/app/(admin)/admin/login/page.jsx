...
import { Lock, Eye, EyeOff, Loader2, ShieldCheck, AlertCircle, Laptop, Mail, Key, CheckCircle2, Clock, ShieldAlert } from "lucide-react";
import { toast } from "sonner";

export default function AdminLoginPage() {
  const [view, setView] = useState("checking"); // checking, login, setup, verify, pending, success
  ...
  useEffect(() => {
    // We start as 'setup' or 'login' based on logic, but now it's basically always login unless it's a new email
    setView("login");
  }, []);
